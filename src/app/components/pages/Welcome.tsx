              ...
              {emailSent ? (
                ...
                <div className="bg-white/85 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.05)] rounded-2xl p-8">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-xl py-3 text-sm font-semibold text-slate-700 hover:bg-white hover:border-slate-300 transition-all active:scale-95 mb-6 shadow-sm"
                  >
                  ...
                  <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center"><span className="bg-white/80 backdrop-blur-sm px-3 text-xs font-medium text-slate-400 rounded-full">ou par email</span></div>
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        {role === "prof" && (
                          <div>
                            ...
                            <input type="text" value={etablissement} onChange={(e) => setEtablissement(e.target.value)} required className="w-full px-3 py-2.5 border border-slate-200/60 rounded-xl text-sm bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-blue-500/20 focus:border-[#0052D4] outline-none transition-all" />
                          </div>
                        )}
                      </div>
                    )}
